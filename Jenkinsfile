pipeline {
    ...
    stages {
        ...
        stage('Run maven clean test') {
            steps {
                sh 'cd /homework/otus-homework mvn clean test -Dbrowser_name=$BROWSER_NAME -Dbrowser_version=$BROWSER_VERSION -Demail=eueiam@mailinator.com -Dpassword=Test1111'
            }
        }
