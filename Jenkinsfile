pipeline {
    ...
    stages {
        ...
        stage('Run maven clean test') {
            steps {
                sh 'mvn -f homework/otus-homework/pom.xml clean test -Dmaven.test.error.ignore=true -Dtest=OtusProfileTest -Dbrowser_name=$BROWSER_NAME -Dbrowser_version=$BROWSER_VERSION -Demail=eueiam@mailinator.com -Dpassword=Test1111'
            }
        }
